...
public class Main {
  ...
  private final static int NUMBER_OF_PARKING_SPACES = 2;
  private final static int NUMBER_OF_CARS = 5;
  private final static int MIN_PARKING_TIME = 3;
  private final static int MAX_PARKING_TIME = 6;
  private final static int MIN_WAITING_TIME = 3;
  private final static int MAX_WAITING_TIME = 6;
